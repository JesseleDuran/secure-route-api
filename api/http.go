...
func New(system actor.System) *gin.Engine {
  ...
  group.GET("directions-crimes", func(c *gin.Context) {
    ...
    r, _ := system.TellSync(actor.RouteCrimes{
      CityID:      1,
      Origin:      o,
      Destination: d,
      Mode:        0,
  ...
  group.GET("/renders/cells-crimes", func(c *gin.Context) {
    system.Tell(actor.GradientMapGeoJSON{CityID: 1})
    c.JSON(200, "done")
  })
